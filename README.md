...
> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install usebila`
...
```sh
# install from the production repo
pip install 'usebila[aiohttp] @ git+ssh://git@github.com/bilasdk/python.git'
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/bilasdk/python/issues) with questions, bugs, or suggestions.
