...
pip install git+ssh://git@github.com/stainless-sdks/bila-python.git
```
...
```sh
# install from this staging repo
pip install 'bila[aiohttp] @ git+ssh://git@github.com/stainless-sdks/bila-python.git'
```
...
You can enable logging by setting the environment variable `BILA_LOG` to `info`.
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/bila-python/tree/main/src/bila/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/bila-python/tree/main/src/bila/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/bila-python/issues) with questions, bugs, or suggestions.
