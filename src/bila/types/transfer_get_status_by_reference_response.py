...
__all__ = [
    ...
    "TransferGetStatusByReferenceResponseData",
    "TransferGetStatusByReferenceResponseDataRecipient",
]


class TransferGetStatusByReferenceResponseDataRecipient(BaseModel):
    """Recipient details"""
...
class TransferGetStatusByReferenceResponseData(BaseModel):
    id: str
    """Transfer ID"""
    ...
    recipient: TransferGetStatusByReferenceResponseDataRecipient
    """Recipient details"""
...
class TransferGetStatusByReferenceResponse(BilaResponse):
    data: Optional[TransferGetStatusByReferenceResponseData] = None
