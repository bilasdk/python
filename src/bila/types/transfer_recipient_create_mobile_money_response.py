...
__all__ = ["TransferRecipientCreateMobileMoneyResponse", "TransferRecipientCreateMobileMoneyResponseData"]


class TransferRecipientCreateMobileMoneyResponseData(BaseModel):
    id: str
    """Recipient UUID"""
...
class TransferRecipientCreateMobileMoneyResponse(BilaResponse):
    data: Optional[TransferRecipientCreateMobileMoneyResponseData] = None
