...
__all__ = ["TransferRecipientCreateBankAccountResponse", "TransferRecipientCreateBankAccountResponseData"]


class TransferRecipientCreateBankAccountResponseData(BaseModel):
    id: str
    """Recipient UUID"""
...
class TransferRecipientCreateBankAccountResponse(BilaResponse):
    data: Optional[TransferRecipientCreateBankAccountResponseData] = None
