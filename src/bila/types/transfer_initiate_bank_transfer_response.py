...
__all__ = [
    ...
    "TransferInitiateBankTransferResponseData",
    "TransferInitiateBankTransferResponseDataRecipient",
]


class TransferInitiateBankTransferResponseDataRecipient(BaseModel):
    """Recipient details"""
...
class TransferInitiateBankTransferResponseData(BaseModel):
    id: str
    """Transfer ID"""
    ...
    recipient: TransferInitiateBankTransferResponseDataRecipient
    """Recipient details"""
...
class TransferInitiateBankTransferResponse(BilaResponse):
    data: Optional[TransferInitiateBankTransferResponseData] = None
