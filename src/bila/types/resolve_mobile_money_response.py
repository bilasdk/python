...
__all__ = ["ResolveMobileMoneyResponse", "ResolveMobileMoneyResponseData"]


class ResolveMobileMoneyResponseData(BaseModel):
...
class ResolveMobileMoneyResponse(BilaResponse):
    data: Optional[ResolveMobileMoneyResponseData] = None
