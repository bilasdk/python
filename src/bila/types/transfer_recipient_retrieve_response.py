...
__all__ = ["TransferRecipientRetrieveResponse", "TransferRecipientRetrieveResponseData"]


class TransferRecipientRetrieveResponseData(BaseModel):
    id: str
    """Recipient UUID"""
...
class TransferRecipientRetrieveResponse(BilaResponse):
    data: Optional[TransferRecipientRetrieveResponseData] = None
